...
//	m = cube_wavefront();
	m = caLoadWavefront("teapot.obj.dat", NULL);
	//m = caLoadWavefront("airboat.obj", NULL);
	//m = caLoadWavefront("al.obj", NULL);
	//m = caLoadWavefront("cube.obj", NULL);
	//m = caLoadWavefront("sample.obj", NULL);
	//m = caLoadWavefront("cornell_box.obj", NULL);
}
